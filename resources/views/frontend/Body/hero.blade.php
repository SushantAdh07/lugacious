...
@section('hero')
    <div class="min-h-screen bg-[#BF8e43] relative overflow-hidden">
        ...
        <div class="relative z-10 container mx-auto px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div class="bg-white/20 border border-white/10 rounded-3xl shadow-glass p-8 mb-16">
                <div class="text-center">
                    <h1 class="text-4xl md:text-5xl font-bold mb-4">
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-white to-[#f8d7a3]">Instagram
                            Fashion</span>
                    </h1>
                    <p class="text-white max-w-2xl mx-auto">Discover the world's most exclusive fashion boutiques and
            ...
            <div class="flex relative mt-6 justify-end">
                {{ $stores->links() }}
            </div>
            ...
            @if (auth()->check() && auth()->user()->role === 'admin')
                <div class="mt-16 text-center">
                    <a href="{{ route('new-store') }}"
                        ...
                        <span
                            class="absolute inset-0 bg-white/10 group-hover:bg-white/20 backdrop-blur-sm transition-all duration-300"></span>
                    </a>
                </div>
            @endif
        </div>
