...
@section('hero')
    <div class="bg-[#FAF7F6] min-h-screen ">
            ...
            <div class="mb-8">
                            ...
                            <div
                                ...
                                <a href="{{ route('store-details', $store->id) }}" class="block">
                                    <div class="relative">
                                        ...
                                        <div class="absolute bottom-4 left-4">
                                            <h4
                                                class="text-xl font-bold text-white group-hover:text-[#BF8e43] transition-colors">
                                                {{ $store->store_name }}</h4>
                                        </div>
                                    </div>
                                </a>
                                <div class="p-4">
                                    <p class="text-gray-600 text-sm mb-3">
                                        {{ Str::limit($store->store_description, 90, '...') }}</p>
                ...
                @else
                    <div class="bg-white rounded-xl p-8 text-center shadow-sm">
                        ...
                        <a href="{{ route('home') }}"
                            class="inline-block px-6 py-2 bg-[#BF8e43] text-white rounded-lg hover:bg-[#BF8e43]/90 transition-colors">
                            Browse Stores
                        </a>
                    </div>
                @endif
