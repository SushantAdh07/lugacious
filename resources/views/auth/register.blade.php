...
<head>
    ...
    <title>Lugacious - Register</title>
    @vite(['resources/css/app.css'])
</head>

<body>
    <section class="font-sans bg-gray-50 dark:bg-gray-900 min-h-screen">
            ...
            <div class="w-full bg-white rounded-lg shadow-sm dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <div class="text-center">
                        ...
                        <p class="text-gray-500 dark:text-gray-300">Create your account in seconds</p>
                    </div>
                    <form class="space-y-4 md:space-y-6" action="{{ route('register') }}" method="POST">
                        ...
                        <p class="text-sm text-center text-gray-500 dark:text-gray-400">
                            Already have an account? <a href="{{ route('login') }}"
                                class="font-medium text-[#BF8e43] hover:underline dark:text-[#BF8e43]">Sign in here</a>
                        </p>
                    </form>
